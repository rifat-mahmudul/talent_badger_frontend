...
const BrandComponent = () => {
    return (
        <div className='flex container mx-auto items-center justify-center'>
            <div className='flex flex-col md:flex-row items-center justify-center gap-[75px]'>

                <p className='text-[#929292] font-normal text-[16px] text-center md:text-left'>
                    TRUSTED BY
                </p>
                ...
                <div className='flex gap-20 flex-wrap justify-center items-center'>
                    ...
                    <Image src={logo4} alt="logos" width={900} height={900} className='w-16 h-14 object-contain' />
                    <Image src={logo5} alt="logos" width={900} height={900} className='w-28 h-6 object-contain' />
                </div>
