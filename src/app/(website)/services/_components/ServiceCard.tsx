    ...
    return (
        <div className="w-full max-w-[496px] bg-white rounded-xl border-t-[3px]  border-[#147575] shadow-[0px_4px_6px_0px_#45B6CA1A]  overflow-hidden">
            ...
            <div className="py-4 px-6">
                <h2 className="text-xl font-semibold text-[#147575] mb-2">{data?.firstName} {data?.lastName}</h2>
                ...
                <div className="grid grid-cols-2 gap-3 mb-6">
                    <div className="flex items-center gap-2 px-3 py-2 bg-[#E8F1F1] rounded-full border border-[#E8F1F1]">
                        ...
                        <span className="text-sm font-medium text-[#147575] ">{data?.skills?.join(" , ")}</span>
                    </div>

                    <div className="flex items-center gap-2 px-3 py-2 bg-[#E8F1F1] rounded-full border border-[#E8F1F1]">
                        <BarChart3 className="w-4 h-4 text-orange-500 flex-shrink-0" />
                        <span className="text-sm font-medium text-gray-700">{data?.experience}</span>
                    </div>
                    <div className="flex items-center gap-2 px-3 py-2 bg-[#E8F1F1] rounded-full border border-[#E8F1F1]">
                        <MessageSquare className="w-4 h-4 text-blue-500 flex-shrink-0" />
                        <span className="text-sm font-medium text-gray-700">{data?.expertise}</span>
                    </div>
                    ...
                    <div className="flex items-center gap-2 px-3 py-2 bg-[#E8F1F1]  border border-[#E8F1F1] rounded-full mb-6 w-fit">
                        ...
                        <span className="text-sm font-medium text-gray-700">{data?.rate}/hrs</span>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-3 w-full">
                   <div className="col-span-1">
                    ...
                    <div className="col-span-1">
                        <button className="w-full flex-1 px-6 py-2.5 bg-[#147575] rounded-lg text-sm font-medium text-white hover:bg-teal-800 transition-colors">
                        Add to My Team
                    </button>
                    </div>
                </div>
