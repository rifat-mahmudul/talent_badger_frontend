          ...
          {team.length === 0 ? (
            ...
            <>
                ...
                {team.map((member, idx) => {
                  ...
                  return (
                    <div
                      key={member._id}
                      className={cn(
                        "group relative bg-white rounded-2xl shadow-sm border border-gray-200 p-4 sm:p-6 hover:shadow-xl transition-all duration-300",
                        "hover:-translate-y-1"
                      )}
                      style={{ animationDelay: `${idx * 100}ms` }}
                    >
                      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-5">
                        ...
                        <div className="flex flex-col sm:flex-row items-center gap-3 w-full sm:w-auto">
                          <input
                            ...
                            className={cn(
                              "w-full sm:w-28 px-3 py-2 border rounded-lg text-sm",
                              assigned && "bg-gray-100 cursor-not-allowed"
                            )}
                          />
                          <Button
                            size="sm"
                        ...
                        <button
                          ...
                          className="p-2 rounded-full hover:bg-red-50 text-gray-400 hover:text-red-600 absolute top-4 right-4 sm:static"
                        >
                          <X className="w-5 h-5" />
                        </button>
                      </div>
              ...
              <div className="mt-12 text-center px-2">
                <div className="inline-block bg-gradient-to-r from-[#00383B] to-[#005A5A] text-white rounded-2xl shadow-2xl p-6 sm:p-8 max-w-2xl">
                  <h2 className="text-xl sm:text-2xl font-bold mb-4 flex items-center justify-center gap-3">
                    <Users className="w-8 h-8" />
                    Ready to Start Your Project?
                  </h2>
                  <p className="text-white/90 mb-6">
                  ...
                  <Button
                    ...
                    disabled={!allEngineersAssigned || team.length === 0}
                    className={cn(
                      "bg-white text-[#00383B] font-semibold text-lg px-8 sm:px-10 py-5 sm:py-6 rounded-xl shadow-lg transition-all duration-200",
                      !allEngineersAssigned || team.length === 0
