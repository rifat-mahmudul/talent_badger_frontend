  ...
  return (
    <div className='pb-[124px]'>
      <div className='bg-white border-[1px] border-[#EEEEEE] shadow-lg rounded-lg pt-5'>
        <h4 className='text-sm leading-[150%] font-semibold text-[#147575] pb-4 border-b border-[#EEEEEE] px-5'>Upcoming Deadlines</h4>
        ...
        <div className='p-5'>
          <div className='p-4 bg-white border-[1px] border-[#EEEEEE] shadow-lg rounded-lg'>
            ...
            <div>
              <button className='bg-[#FEE2E2] py-1 px-2 rounded-full text-sm text-[#991B1B] font-medium leading-[16px]'>15/10/2025</button>
            </div>
            </div>
          </div>
        </div>
